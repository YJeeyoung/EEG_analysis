...
for filename in os.listdir(annot_base_dir):
    ...
    if os.path.exists(f'{trace_base_dir}\{mouse_id}_export_24.mat'):
        trace_dir = f'{trace_base_dir}\{mouse_id}_export_24.mat'
    else:
        trace_dir = f'{trace_base_dir}\{mouse_id}_export.edf'
    annot_dir = f'{annot_base_dir}\{mouse_id}_scores.tsv'
    d_med1, d_med2, d_med3, l_med1, l_med2, l_med3 = get_median_FFT_for_mouse(trace_dir, annot_dir)
    whole_mouse_dict[mouse_id] = [d_med1, d_med2, d_med3, l_med1, l_med2, l_med3]
